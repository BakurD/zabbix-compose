...
На сегодняшний день самая свежая версия 2.17.3. Проверить наличие новой версии можно тут [Docker Compose GitHub](https://github.com/docker/compose/releases)
```bash
